...
<body>
    ...
    <!-- Start Top Search -->
    <form >
    <div class="top-search" action="post" action="art.php">
        <div class="container">
            <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-search"></i></span>
                <input type="text" class="form-control" name="valueToSearch" placeholder="Search">
                <span class="input-group-addon close-search" name="search"><i class="fa fa-times"></i></span>
            </div>
        </div>
    </div>
    </form>
									...
									<div class="col-sm-4 col-md-4 col-lg-3 col-xl-3">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/paint1.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-3">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/paint2.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-3">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/paint3.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-3">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/paint4.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-3">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/paint5.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-3">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/paint6.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-3">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/paint7.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-3">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="images/paint8.jpg" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
