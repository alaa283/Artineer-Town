...
if(isset($_POST['insert_art']))
{
  ...
  $image=$_POST['image'];
  $price=$_POST['price'];
  $sql=mysqli_query($con,"INSERT INTO `product`(`Pname`, `image`, `Price`) VALUES ('$name','$image','$price')");
}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="name art" required data-error="Please enter your name">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="submit-button text-center">
                                        <button class="btn hvr-hover" id="submit" type="submit" name="insert_art">Send Message</button>
...
<table>
      ...
      <?php
      $query="SELECT  `Id`, `Pname`, `Price` FROM `product`";
